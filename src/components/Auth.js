...
const initialFormState = {
    fullName: '', username: '', password: '', cnfPassword: '', phoneNumber: '', avatarURL: ''
};
...
const Auth = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        const { data: { token, userId, hashedPassword } } = await axios.post(`${backendURL}/${isSignup ? 'signup' : 'login'}`, { fullName, username, password, phoneNumber, avatarURL });
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        { isSignup && (
                            <div className="auth__form-container_fields-content_input">
                                ...
                                <input name="cnfPassword" type="password" placeholder="Confirm Password" onChange={handleChange} required />
                            </div>
                        )}
